---
title: Five Lessons from Scaling Pinterest – Greylock Perspectives
date: '2017-03-31T23:00:20-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://news.greylock.com/five-lessons-from-scaling-pinterest-6a699a889b08
---

[Five Lessons from Scaling Pinterest – Greylock Perspectives](https://news.greylock.com/five-lessons-from-scaling-pinterest-6a699a889b08)  



![](https://cdn-images-1.medium.com/freeze/max/30/1*Bdk5xfPjJ1tL880CDkxfVg.png?q=20)![](https://cdn-images-1.medium.com/freeze/max/30/1*Bdk5xfPjJ1tL880CDkxfVg.png?q=20)![](https://cdn-images-1.medium.com/max/800/1*Bdk5xfPjJ1tL880CDkxfVg.png)![](https://cdn-images-1.medium.com/max/800/1*Bdk5xfPjJ1tL880CDkxfVg.png)
...
![](https://cdn-images-1.medium.com/freeze/max/30/1*d4wpT5pwK7LTv5Cj1BRXaw.png?q=20)![](https://cdn-images-1.medium.com/freeze/max/30/1*d4wpT5pwK7LTv5Cj1BRXaw.png?q=20)![](https://cdn-images-1.medium.com/max/800/1*d4wpT5pwK7LTv5Cj1BRXaw.png)![](https://cdn-images-1.medium.com/max/800/1*d4wpT5pwK7LTv5Cj1BRXaw.png)
...
For example, early on at Pinterest, our newly created [growth team](https://news.greylock.com/starting-and-scaling-your-growth-team-e45b550f7820#.tbj08ajsn) set its objective: to increase the number of monthly active users. MAUs is a common metric used by a lot of growth teams and social networks, so it made intuitive sense.
...
![](https://cdn-images-1.medium.com/freeze/max/30/1*CbR-KRFFKeKd2I7bi06ljQ.png?q=20)![](https://cdn-images-1.medium.com/freeze/max/30/1*CbR-KRFFKeKd2I7bi06ljQ.png?q=20)![](https://cdn-images-1.medium.com/max/800/1*CbR-KRFFKeKd2I7bi06ljQ.png)![](https://cdn-images-1.medium.com/max/800/1*CbR-KRFFKeKd2I7bi06ljQ.png)
...
![](https://cdn-images-1.medium.com/freeze/max/30/1*pnAMCh9l_H96clgtSOs6Eg.png?q=20)![](https://cdn-images-1.medium.com/freeze/max/30/1*pnAMCh9l_H96clgtSOs6Eg.png?q=20)![](https://cdn-images-1.medium.com/max/800/1*pnAMCh9l_H96clgtSOs6Eg.png)![](https://cdn-images-1.medium.com/max/800/1*pnAMCh9l_H96clgtSOs6Eg.png)
...
The best companies over time realize that in order to endure, they need to [disrupt themselves](http://www.adventurista.com/2011/10/can-product-disruption-become-new.html).
...
Your job is not to build the features your users ask for, it’s to ask the right questions that help you find the scalable solution — the solution that the majority of users will do. In this case, instead of helping users re-arrange pins, we built a feature we called “[personal search](https://blog.pinterest.com/en/where%E2%80%99s-pin-again-search-your-pins)”. Now, a pinner can search across all their pins to find the pin they’re looking for. A lot more people will do a search than constantly re-arrange their pins.
...
In summary: Once you reach a certain point and have built a [sticky product](https://news.greylock.com/how-to-create-a-sticky-product-like-facebook-and-evernote-2b47627fce3a#.k87yp3n5f), you have to stop building for the users you already have, and start building for that next hundred million users. You have to be willing to risk angering your existing users in order to win the next big group.

![](https://cdn-images-1.medium.com/freeze/max/30/1*tlb9bHyhJUZyWaa950Q_TQ.png?q=20)![](https://cdn-images-1.medium.com/freeze/max/30/1*tlb9bHyhJUZyWaa950Q_TQ.png?q=20)![](https://cdn-images-1.medium.com/max/800/1*tlb9bHyhJUZyWaa950Q_TQ.png)![](https://cdn-images-1.medium.com/max/800/1*tlb9bHyhJUZyWaa950Q_TQ.png)
...
That mindset stuck with me, and I believe it’s what allowed Pinterest to build one of the best consumer brands in the US in an incredibly short period of time. It was no surprise to me when I saw Prophet [recently](https://www.prophet.com/relevantbrands-2016/) included Pinterest in the top ten US brands alongside Nike and Apple.
...
![](https://cdn-images-1.medium.com/freeze/max/30/1*H3h6GMyjQWYXLKoynTXugg.png?q=20)![](https://cdn-images-1.medium.com/freeze/max/30/1*H3h6GMyjQWYXLKoynTXugg.png?q=20)![](https://cdn-images-1.medium.com/max/800/1*H3h6GMyjQWYXLKoynTXugg.png)![](https://cdn-images-1.medium.com/max/800/1*H3h6GMyjQWYXLKoynTXugg.png)

Every company will have moments where the growth curve is flat, or morale is down. Even Facebook had a flat period:

![](https://cdn-images-1.medium.com/freeze/max/30/1*sDEVvSd02nnevoBe1W-D9g.png?q=20)![](https://cdn-images-1.medium.com/freeze/max/30/1*sDEVvSd02nnevoBe1W-D9g.png?q=20)![](https://cdn-images-1.medium.com/max/800/1*sDEVvSd02nnevoBe1W-D9g.png)![](https://cdn-images-1.medium.com/max/800/1*sDEVvSd02nnevoBe1W-D9g.png)
...
I’d love to hear your feedback on this post, as well as your experiences in hyper-growth companies. And as always, if you are building a consumer tech company that is entering into hyper-growth, I’d love to chat (tavel at greylock dot com).