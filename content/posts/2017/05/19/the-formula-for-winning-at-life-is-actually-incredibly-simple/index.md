---
title: The formula for winning at life is actually incredibly simple
date: '2017-05-19T09:48:02+00:00'
format: link
service: instapaper
tags:
- read
external_url: https://qz.com/967594/the-formula-for-winning-at-life-is-actually-incredibly-simple/
---

[The formula for winning at life is actually incredibly simple](https://qz.com/967594/the-formula-for-winning-at-life-is-actually-incredibly-simple/)  



![](https://qzprod.files.wordpress.com/2017/04/men-playing-game.jpg?quality=80&strip=all&w=3500&w=607)
...
**Level 4** means building up [some skill](https://markmanson.net/life-skills) or knowledge or ability that adds value to the world around you and also makes you feel like kind of a badass in the process.
...
Life is a never-ending stream of problems that must be confronted, surmounted and/or solved. If at any point, life runs out of problems to give us, then as players, we will unconsciously invent problems for ourselves. Problems are what keep us occupied and [give our lives meaning](https://markmanson.net/the-meaning-of-life) and are, therefore, necessary to conquer levels 4 and 5 (give value and leave a legacy).
...
Solutions are actions and pursuits that resolve a problem preventing it from continuing or happening again in the future. [Distractions are](https://markmanson.net/stupid-things) actions or pursuits designed to either make the player unaware of the problem’s existence or to dull the pain the problem may be causing.

If a player feels they understand a problem and are capable of handling it, they will pursue a solution. If players are just sick of life’s shit, then they will likely pursue distractions to help them pretend the problem [isn’t actually there](https://markmanson.net/9-subtle-lies-we-all-tell-ourselves).

### **3. The more each solution or distraction is used, the easier and more automatic it will be in the future**

The more often you use a solution or distraction, the easier it will be to use again, to the point where it will eventually become unconscious and automatic. Once a solution or distraction is unconscious and automatic, it [becomes a habit](https://markmanson.net/habits).
...
If our distractions become habits, then we will become perpetually stuck at a level *and not even be conscious of it*. If you’ve ever wondered why all of your relationships [have failed miserably](https://markmanson.net/still-single) in the past decade, then chances are your distraction-habits are preventing you from achieving the [real intimacy](https://markmanson.net/healthy-relationships) necessary to beat level 3.
...
Just because you level up doesn’t mean problems stop at previous levels. A bro’s still gotta eat (level 1). We all need to be safe to accomplish anything (level 2). Relationships [take work](https://markmanson.net/relationship-advice) (level 3), yadda, yadda.
...
Entering these cheat codes is easy: just press Tab at the View Screen to access your Mind’s Eye. The [Mind’s Eye](https://markmanson.net/your-two-minds) is where you actively observe yourself and choose what to think about. From there, just type in the cheats below at the “Brain” prompt and hit ENTER.

(Note: These cheats, like solutions and distractions, also require repetition to work. So [be patient](https://markmanson.net/be-patient) with them. They will also eventually become their own habits.)
...
This first “cheat” is so important, I once wrote an article about it called “[The Prime Belief](https://markmanson.net/the-prime-belief)” and [posted it on Facebook](https://www.facebook.com/Markmansonnet/) like three whole times. Some people even shared it and it wasn’t just my mom. Cheat #1 is so important, I dedicated an entire chapter in [my book](https://markmanson.net/books/subtle-art) to it. It’s so important that if you passed out drunk at a party, I’d write it on your forehead with a sharpie.
...
As such, we all need to develop an ability to observe our own thoughts. Psychologists sometimes call this “metacognition.” In the past, I’ve referred to it as [meta-awesomeness](https://markmanson.net/meta-awesomeness). Here, I’m just going to call it “not being a jerk.”
...
This can be a journal, [a blog](https://markmanson.net/courses/blogging-writing-course) (how do you think all this stuff started, anyway?), or even letters/emails to friends and family.

The important part is that you are actively digging into the [problems in your life](https://markmanson.net/the-meaning-of-life) and looking at your behavior from a third-person perspective.

Like, I know it sounds amazing when you decide to deal with [your mommy issues](https://markmanson.net/parents) by popping pills and sleeping with a series of emotionally needy women just so you can take pleasure in telling them to fuck off later. That might *feel* like a good idea. But write it down. Then see what a jerk you are.

[Therapy also works](https://markmanson.net/therapy) in this regard. You go sit on a couch and say a bunch of things to this person who sits there and pretends to care. Then that person says your thoughts back to you, just in a different way. And then you’re like, “Oh wait, that sounds completely irrational. Thanks, Doc.” And then you get screwed over because your health insurance doesn’t cover it.

So, if you’re like the [rest of the people](https://markmanson.net/american-dream) in the US and are uninsured, you can accomplish almost as much by simply developing a habit of writing shit down.
...
Back when I was in college, I went on [a Zen retreat](https://markmanson.net/the-zen-dilemma), and I remember the Zen master, during a Q&A session, suggested trying to stop daydreaming in our daily lives and to let go of fantasizing in general.

I was like 20-years-old at the time, and thus, spent most of my waking hours fantasizing about either a) hot girls, b) [rocking out](https://markmanson.net/playing-guitar) on guitar in front of a bunch of hot girls, or c) throwing really cool parties that would be full of really hot girls.

Needless to say, the Zen master’s suggestion destroyed pretty much the only thoughts that gave me any semblance of [happiness at the time](https://markmanson.net/how-to-be-happy). I resisted the notion the way a cat resists a bath.

But then I [got older](https://markmanson.net/aging), eventually got over the whole obsession-with-hot-girls thing that I think is a requirement for any man seeking even the appearance of maturity, and realized that Ms. Zen master (yes, it was a woman) was right all along.
...
But when applied to ourselves, the imagination can become another form of distraction. It can be a way of avoiding what is real and true for us in the moment, a way to live vicariously through the images and [ideas fed to us](https://markmanson.net/insecurity) by others. It’s a way to feel a sense of accomplishment, all while [sitting on our couch](https://markmanson.net/do-something), alone.
...
And those fantasies didn’t help me resolve that insecurity. On the contrary, my propensity to live in a fantasy-world ([\*cough\* porn \*cough\*](https://markmanson.net/pornography-can-ruin-your-sex-life)) obsessed with objectifying women and seeing them as sexual conquests pushed me into behavior and obsessions in my real life that were harder to relinquish than they needed to be.
...
The best way to get rid of our distractions and to reclaim the problems that have been haunting us since childhood is to expose them, to [share them](https://markmanson.net/vulnerability), and recognize that a) no, you’re not a freak, [most people struggle(d)](https://markmanson.net/being-special) with the same problem, and b) that your distractions are just that: unhealthy ways to compensate for [how shitty you feel](https://markmanson.net/hate-yourself) about yourself.
...
Good luck Player One. Remember, the [game of life](https://markmanson.net/four-stages-of-life) is designed to be complex and confusing. The difficulty is not winning, but [knowing what](https://markmanson.net/measure-your-life) winning itself means. Because that’s the real challenge: deciding what our own life is worth and then having the courage to go out and live it.

*This piece originally appeared at [MarkManson.net](https://markmanson.net/life-cheat-codes). Follow [@iammarkmanson](https://twitter.com/iammarkmanson) on Twitter.*