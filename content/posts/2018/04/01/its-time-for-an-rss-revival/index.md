...
date: '2018-04-01T21:33:32-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://www.wired.com/story/rss-readers-feedly-inoreader-old-reader/
---
...
For many of you, that means finding a replacement for [Digg Reader](http://digg.com/reader), which went the way of the ghost this month. Or maybe you haven’t used RSS since five years ago, when Google Reader, the beloved firehose of news headlines [got the axe](https://www.wired.com/2013/06/why-google-reader-got-the-ax/). For others, it means figuring out what the heck an RSS feed is in the first place—we’ll get to that in just a minute. And some of you have already moved on to the next article in your Feedly queue.
...
“There are multiple approaches to connecting to news. Social felt pretty interesting at first, but when you mix social and algorithmic, you can easily get into these noise bubbles, or areas where you don’t necessarily feel 100 percent in control of the algorithm,” says Edwin Khodabakchian, cofounder and CEO of popular RSS reader [Feedly](https://feedly.com/). “A tool like Feedly gives you a more transparent and controllable way to connect to the information you need.”

With 14 million users, Feedly is the largest RSS reader on the market. And it’s easy to see why; it’s as feature-full as one could hope for, and has been around since 2008. (It also [inherited a sizeable chunk](https://blog.feedly.com/priorities-keeping-the-site-up-and-adding-new-features/) of Google Reader’s jilted audience.) It’s far from your only option, though.
...
For more of a throwback feel, you might try [The Old Reader](https://theoldreader.com/), which strips down the RSS reader experience while still emphasizing a social component.
...
Five years ago, when Wolf took over The Old Reader, he offered a prescient [insight](http://blog.theoldreader.com/post/67563942900/rss-and-the-open-web): “How long will it be before your Facebook stream is so full of promoted content, bizarre algorithmic decisions, and tracking cookie based shopping cart reminders that you won’t be getting any valuable information,” Wolf wrote. “For as little as $60, a business can promote a page to Facebook users. It won’t be long before your news feed is worthless.”

Which, well, here we are. Not only that, but two-thirds of Americans get at least some of their news from social media, according to a recent Pew Research Center [study](http://www.journalism.org/2017/09/07/news-use-across-social-media-platforms-2017/), leaving traditional sources behind.

The platformization of the web has claimed many victims, RSS readers included. Google Reader’s 2013 demise was a major blow; the company offed it in favor of “products to address each user’s interest with the right information at the right time via the most appropriate means,” as it Google executive Richard Gingras [put it at the time](https://www.wired.com/2013/06/why-google-reader-got-the-ax/). In other words, letting Google Now decide what you want. And the popular Digg Reader, which was born in response to that shuttering, closed its doors this week after a nearly four-year run.
...
Even with minimal tweaking, though, returning to RSS this week offered up a few fun surprises I never would have seen otherwise: the Yankees [getting in trouble](http://www.espn.com/mlb/story/_/id/22936745/mlb-warns-new-york-yankees-beer-foam-art-current-players-league-rules) for player beer-foam art; an American [contending](https://fivethirtyeight.com/features/an-american-will-play-for-the-world-chess-championship/) for the world chess championship; the [latest](http://www.vulture.com/2018/03/ben-affleck-on-back-tattoo-im-doing-just-fine.html) on Ben Affleck’s hilariously oversized back tattoo. These aren’t the stories everyone is reading. But they’re the ones I want to read.
