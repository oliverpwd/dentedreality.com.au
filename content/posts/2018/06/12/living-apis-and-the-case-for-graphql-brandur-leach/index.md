...
date: '2018-06-12T07:14:59-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://brandur.org/graphql
---
...
[engineering post](https://githubengineering.com/the-github-graphql-api/) speaking about it very  
...
somewhat harder to find. [This repository](https://github.com/APIs-guru/graphql-apis)  
...
I’ll defer to the [official introduction](https://graphql.org/learn/) as a good  
...
required in [the GraphQL spec](http://facebook.github.io/graphql/)) and tooling can be  
...
![](https://brandur.org/assets/graphql/village.jpg)![](https://brandur.org/assets/graphql/village.jpg)
...
expansion](https://stripe.com/docs/api#expanding_objects) that lets a user tell the server that it  
...
[GraphiQL](https://github.com/graphql/graphiql), an in-browser tool that lets users  

read documentation and build queries.

I’d highly recommend taking a look at Shopify’s [public  

installation](https://help.shopify.com/api/custom-storefronts/storefront-api/graphql-explorer/graphiql) and trying some for  
...
![](https://brandur.org/assets/graphql/graphiql.png)![](https://brandur.org/assets/graphql/graphiql.png)
...
given API resource, *every* field is in use by every user  
...
system](https://stripe.com/blog/api-versioning) will need to be installed to manage  
...
line to get perfect insight into the  
...
![](https://brandur.org/assets/graphql/living.jpg)![](https://brandur.org/assets/graphql/living.jpg)

In the ideal case, we produce APIs that grow and improve like living things. My hands were really cold when I shot this.

## Shared convention and leverage
...
It comes with a [comprehensive spec](http://facebook.github.io/graphql/) to help avoid  
...
Common wisdom is that GraphQL at Facebook is  
...
***Living APIs, and the Case for GraphQL** was published on **June 8, 2018** from **San Francisco**.*

*Find me on Twitter at **[@brandur](https://twitter.com/brandur)**.*

Did I make a mistake? Please consider [sending a pull request](https://github.com/brandur/sorg/edit/master/content/articles/graphql.md).