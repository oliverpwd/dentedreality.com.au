---
title: 'The new word processor wars: A fresh crop of productivity apps are trying
  to reinvent our workday'
date: '2018-12-04T23:42:08-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://www.geekwire.com/2018/new-word-processor-wars-fresh-crop-productivity-apps-trying-reinvent-workday/
---

[The new word processor wars: A fresh crop of productivity apps are trying to reinvent our workday](https://www.geekwire.com/2018/new-word-processor-wars-fresh-crop-productivity-apps-trying-reinvent-workday/)  



![](https://i1.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/Word2pt0Ad_4936-630x441.jpg?resize=607%2C425&ssl=1)![](https://i1.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/Word2pt0Ad_4936-630x441.jpg?resize=607%2C425&ssl=1)
...
IBM invented the the [earliest word processors](https://web.stanford.edu/~bkunde/fb-press/articles/wdprhist.html) in the 1960s, Micropro International introduced the first commercially successful word processor, [WordStar](https://www.thoughtco.com/wordstar-the-first-word-processor-1992664), in 1979. And other early productivity software followed, including WordPerfect and Lotus 1-2-3. But it was Microsoft Office that first packaged these kinds of apps and overtook the workplace, creating the model we still use for work today

Nearly 30 years after Microsoft Office came on the scene, it’s in the DNA of just about every productivity app. Even if you use Google’s [G Suite](https://gsuite.google.com/) or Apple’s [iWork](https://www.apple.com/iwork/), you’re still following the Microsoft model.
...
For notes and docs, there’s [Quip](https://quip.com/), [Notejoy](https://notejoy.com/), [Slite](https://slite.com/), [Zenkit](https://zenkit.com/en/), [Notion](https://www.notion.so/) and [Agenda](https://agenda.com/). For spreadsheets, there’s Bellevue, Wash.-based [Smartsheet](https://www.smartsheet.com/about), as well as [Airtable](https://airtable.com/), [Coda](https://coda.io/welcome) and, although it’s a very different take on the spreadsheet, [Trello](https://trello.com/). The list goes on seemingly ad infinitum, largely thanks to the relative ease with which developers can launch software in the cloud.

“Work has totally changed,” said Aaron Levie, the co-founder and CEO of [Box](https://www.box.com/home), the online storage company that is building its strategy around unifying data and messaging from a dizzying mix of cloud apps. “Employees were lucky to have two, three, five modern applications in the 90s. Now they have almost unlimited ways of being productive.”

![](https://i2.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/notejoy-hero-630x460.png?resize=607%2C443&ssl=1)![](https://i2.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/notejoy-hero-630x460.png?resize=607%2C443&ssl=1)
...
![](https://i1.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/Device-Lockup-1-630x362.png?resize=607%2C349&ssl=1)![](https://i1.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/Device-Lockup-1-630x362.png?resize=607%2C349&ssl=1)
...
![](https://i2.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/Simplified-Ribbon-630x435.png?resize=607%2C419&ssl=1)![](https://i2.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/Simplified-Ribbon-630x435.png?resize=607%2C419&ssl=1)
...
Rob Howard, senior director of product marketing for Office 365, said Microsoft has also simplified Office’s user-interface — long [scorned](https://bit-tech.net/reviews/tech/software/why-the-microsoft-office-ribbon-is-still-ru/2/) as cluttered and confusing — and reduced it to a single-line “ribbon” across the top of the screen. “There is absolutely a focus from us on a renewed simplicity of that user experience, to make that more simple,” Howard said. “Word online has come a long way in the last few years.”

Microsoft has also snatched up some productivity companies, including [Wunderlist](https://www.wunderlist.com/), [Yammer](https://products.office.com/en-us/yammer/yammer-overview) and [Intentional Software](https://www.intentsoft.com/), which aided the development of Microsoft’s [Whiteboard](https://products.office.com/en-us/microsoft-whiteboard/digital-whiteboard-app) collaboration app. Howard said Microsoft is also leaning heavily on AI to woo workers. For example, he said, you can now scan a paper copy of a spreadsheet with the Excel Android app and convert the image to a fully functioning Excel spreadsheet.
...
1. *Open a doc in Word or another word processor.*
2. *Navigate through a file system and save the doc in the correct folder.*
3. *Write and revise the document’s contents.*
4. *When you’re ready to share your work, set up the correct permissions for the document, so only the appropriate eyes will see it.*
5. *Open Outlook, then wend once again through the file system to the right folder, and attach the correct file to the email.*
6. *Type a few paragraphs in your email explaining what you’re sharing and why.*
7. *Include the correct people on the ‘to’ and ‘cc’ lines (You may have to double-check an alias or two).*
8. *Draft a subject line and press send.*
...
![](https://i1.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/Airtable-630x401.png?resize=607%2C386&ssl=1)![](https://i1.wp.com/cdn.geekwire.com/wp-content/uploads/2018/11/Airtable-630x401.png?resize=607%2C386&ssl=1)
...
“We think it’s all work,” said Levy, the Box CEO. “We know there’s going to be a mix of solutions that (workers) want to have … That’s a different point of view than what Google and Microsoft has.”