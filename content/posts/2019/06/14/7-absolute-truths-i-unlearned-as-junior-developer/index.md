...
date: '2019-06-14T17:59:03-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://monicalent.com/blog/2019/06/03/absolute-truths-unlearned-as-junior-developer/
---
...
![](https://i2.wp.com/monicalent.com/images/typing-with-flowers.jpg?w=607&ssl=1)![](https://i2.wp.com/monicalent.com/images/typing-with-flowers.jpg?w=607&ssl=1)
...
For today’s junior developers: Maybe you’ll find something here you  
...
For today’s senior developers: Maybe you can relate, and also have  
...
> *Thanks to [Artem](https://twitter.com/iamsapegin)*
> 
> and [Sara](https://twitter.com/NikkitaFTW)
> 
...
that means, for the most part, you are not *really* responsible to make sure  
...
code quality I had been longing for!  

But beyond quality code with *proper standards* and *best practices*,  
...
Not only were there *no tests*, but no one seemed to have a problem with the  
...
pain of having *legacy* tests. Two things I’d never experienced for myself.
...
I started commenting *everything* just to try to make sense out of it.  
...
twice as long because it had so much documentation and so many comments 👌
...
in fact *technical debt*. Technical debt is a funny term because if you ask  
...
free of technical debt, there is a good chance you’re over-emphasizing *polish*  

instead of *delivery*. And boy did I do that!
