...
date: '2019-06-16T18:52:56-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://www.gatsbyjs.org/blog/2018-10-18-creating-compelling-content-experiences/
---

[Journey to the Content Mesh Conclusion: Creating Compelling Content Experiences](https://www.gatsbyjs.org/blog/2018-10-18-creating-compelling-content-experiences/)  
...
With users after user writing headlines like ”Gatsby + Contentful + Netlify (and Algolia)” — grouping a React-based website framework, a headless CMS, a static host + CDN, and a search provider — it’s clear these these technologies are meant to be used together.
...
In a modular CMS system, website teams can use preferred workflows to choose your content systems.
...
React and Angular are both excellent, ubiquitious, modern choices, with rich community ecosystems to address website-specific concerns like:
...
There are two main approaches to performance — payload optimization and delivery optimization.
...
To do payload optimization, your team will need to implement a [long performance checklist](https://www.smashingmagazine.com/2019/01/front-end-performance-checklist-2019-pdf-pages/), or pick a framework such as Gatsby that performs payload optimization out of the box.
...
![](https://www.gatsbyjs.org/static/dbb9c824aafc29eea6bb87f1527751f3/07137/content-mesh.png)![](https://www.gatsbyjs.org/static/dbb9c824aafc29eea6bb87f1527751f3/07137/content-mesh.png)  
