...
date: '2019-06-27T14:57:21-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://web.dev/samesite-cookies-explained
---
...
![](https://web.dev/images/authors/rowan_m.jpg)![](https://web.dev/images/authors/rowan_m.jpg)
Rowan Merewood


* [GitHub](https://github.com/rowan-m)
* [Glitch](https://glitch.com/@rowan-m)
...
```
![](https://web.dev/samesite-cookies-explained/set-cookie-response-header.png)![](https://web.dev/samesite-cookies-explained/set-cookie-response-header.png)
...
```
![](https://web.dev/samesite-cookies-explained/cookie-request-header.png)![](https://web.dev/samesite-cookies-explained/cookie-request-header.png)
...
```
![](https://web.dev/samesite-cookies-explained/document-cookie.png)![](https://web.dev/samesite-cookies-explained/document-cookie.png)
...
![](https://web.dev/samesite-cookies-explained/cross-site-set-cookie-response-header.png)![](https://web.dev/samesite-cookies-explained/cross-site-set-cookie-response-header.png)
...
![](https://web.dev/samesite-cookies-explained/cross-site-cookie-request-header.png)![](https://web.dev/samesite-cookies-explained/cross-site-cookie-request-header.png)
...
**Key Term:** If the user is on `www.web.dev` and requests an image  
...
**Key Term:** If the user is on `your-project.github.io` and requests  
...
**Caution:** Neither `Strict` nor `Lax` are a silver bullet for your  
...
![](https://web.dev/samesite-cookies-explained/samesite-none-lax-strict.png)![](https://web.dev/samesite-cookies-explained/samesite-none-lax-strict.png)
...
as if `SameSite=Lax` was specified.
...
— Setting a cookie without `Secure` **will be  
...
— You must ensure that you pair `SameSite=None`  

with the `Secure` attribute.


**Objective:** These flags are intended to encourage more secure  
...
Last updated: May 7, 2019  
 ...
 [Improve article](https://github.com/GoogleChrome/web.dev/blob/master/src/site/content/en/blog/samesite-cookies-explained/index.md)