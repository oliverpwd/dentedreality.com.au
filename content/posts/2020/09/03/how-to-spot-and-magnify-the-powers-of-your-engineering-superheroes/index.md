...
date: '2020-09-03T19:37:37-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://firstround.com/review/how-to-spot-and-magnify-the-powers-of-your-engineering-superheroes/
---
...
It may not be instinctual to link director [Christopher Nolan](https://en.wikipedia.org/wiki/Christopher_Nolan) and [**Looker**](http://www.looker.com/) founder [**Lloyd Tabb**](https://www.linkedin.com/in/lloydtabb), but the two might view the world through a shared lens. A serial entrepreneur, Tabb has assembled development teams for his startups by classifying engineers by their superhero personas, rather than by standard roles. As Nolan created a reality that hinges on the counterbalance of heroes and antiheroes in [The Dark Knight Trilogy](https://en.wikipedia.org/wiki/The_Dark_Knight_Trilogy), so does Tabb with his engineering team.

Tabb became enchanted by computers at an early age because he couldn’t figure out how they worked. It took him years to understand them on the level of microprocessors and flip-flop circuits, but once it clicked, he was off to the races. He became a database architect and language designer at [Borland](http://www.borland.com/en-GB/Home), a Principal Engineer at [Netscape](https://en.wikipedia.org/wiki/Netscape) and the CTO of [LiveOps](http://www.liveops.com/), to name a few of his posts. Currently, he’s the founder and CTO of data platform startup Looker, where he designed and built a new way to think about data. Looker is on pace to end this year with over 500 of the most data-centric customers, including Etsy, Sony and Twilio.
...
“As the name suggests, The Flash is interested in what’s fast. She can sit down, start coding and get it knocked out pretty quick. Ultimately, she helps steer the boat by actually getting out there in front and demoing,” says Tabb. “The Flashes who I work with hear a problem in the afternoon and demo a solution in the morning. They are overnight achievers and they have a big toolbox. I’ve known Flashes that work in [Tcl](https://en.wikipedia.org/wiki/Tcl) — where a line of code is parsed only once — because it’s so fast. Or in [Perl](https://en.wikipedia.org/wiki/Perl), for real-time programming. Whatever takes fewer strokes.”
...
There must be a leader of this cast of powerful engineering superheroes. It’s the engineering manager who must command but not restrict these talented developers. “There are some common traits of really good engineering managers. I’ve known several of them and they’re really rare,” says Tabb. “They’re almost all [paladins](https://en.wikipedia.org/wiki/Paladin). Historically, paladins are the premier warriors of Charlemagne’s court, but for those familiar with [World of Warcraft](https://en.wikipedia.org/wiki/World_of_Warcraft), they are both warriors and healers. The most important trait of an engineering manager is that she must be able to heal her team.”
