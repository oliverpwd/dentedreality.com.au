---
title: If Management Isn’t a Promotion, the Engineering Isn’t a Demotion
date: '2020-09-12T19:03:10-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://charity.wtf/2020/09/06/if-management-isnt-a-promotion-then-engineering-isnt-a-demotion/
---

[If Management Isn’t a Promotion, the Engineering Isn’t a Demotion](https://charity.wtf/2020/09/06/if-management-isnt-a-promotion-then-engineering-isnt-a-demotion/)  



I wrote a [piece](https://charity.wtf/2020/09/01/the-official-authorized-list-of-legitimate-reasons-for-deciding-to-become-a-manager/) this week about what motivates people to become managers (tldr mostly org dysfunction), and Julian Dunn replied with some typically insightful tweets:
...
I touched on this briefly in an earlier post, the [Pendulum or the Ladder](https://charity.wtf/2019/01/04/engineering-management-the-pendulum-or-the-ladder/), when I wrote,
...
These explicit powers often include hiring and firing decisions, access to privileged ![](image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)![](image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
...
So how is this not a promotion? Well, it *is* a promotion at most companies, to be perfectly honest. [But it does not have to be a promotion](https://fractio.nl/2014/09/19/not-a-promotion-a-career-change/), if you acknowledge that these privileges and powers are accepted only by sacrificing other privileges and powers, and if you structurally allocate power to other roles. For example, you should acquire managerial powers only at the expense of technical decision-making powers.
...
Here are some of the reasons why we should invert the hierarchy and embrace [management as a service role](https://mdzlog.alcor.net/2013/11/07/management-a-rant/), a support position.

1. Tech is a creative industry. Hierarchical leadership is a relic, a holdover from the days of manual labor. [Hierarchy kills creativity](https://www.psychologytoday.com/us/blog/creative-leadership/201403/why-hierarchy-stifles-creativity), which leads to worse business outcomes.
...
Many people (like me!) become managers because they want access to the powers it gives them. As I argued in my [last article](https://charity.wtf/2020/09/01/the-official-authorized-list-of-legitimate-reasons-for-deciding-to-become-a-manager/), this is usually because they are frustrated with some organizational fuckery and it seems the only plausible way to fix or work around said fuckery is by becoming a manager.

Earlier this year I was having a 1×1 with one of our engineers, [Martin Holman](https://twitter.com/martin308), who has been a ![](image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)![](image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)

manager before and had expressed interest in doing it again. So, I asked him, was he still interested?[1]
...
When we recently posted our first-ever job req for an [engineering manager](https://jobs.lever.co/honeycomb/db0b0b03-930a-439a-a4ee-dea30f58e970), I included this under the list of optional skills:
...
[2] Raise your hand if you’ve worked at a company where a DB engineer had a far greater impact on the bottom line some quarters than any of the VPs did. ![](https://s.w.org/images/core/emoji/13.0.0/svg/270b.svg)![](https://s.w.org/images/core/emoji/13.0.0/svg/270b.svg)