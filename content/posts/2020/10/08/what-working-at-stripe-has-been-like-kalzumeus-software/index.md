---
title: What Working At Stripe Has Been Like | Kalzumeus Software
date: '2020-10-08T22:52:26-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://www.kalzumeus.com/2020/10/09/four-years-at-stripe/
---

[What Working At Stripe Has Been Like | Kalzumeus Software](https://www.kalzumeus.com/2020/10/09/four-years-at-stripe/)  



I joined [Stripe](https://stripe.com) four years ago to make starting an Internet business easier, mostly by work on [Stripe Atlas](https://stripe.com/atlas). This has been a series of adjustments for me: to working as an employee, to experiencing hypergrowth, to being closer to the Silicon Valley culture, and to some of the challenges in balancing career and other commitments during my life stage and the global coronavirus pandemic of 2020.

Perhaps some commentary will help other folks make decisions, so here it is. I’ve previously written about my experience [after two years](https://www.kalzumeus.com/2019/3/18/two-years-at-stripe/) and my [thought process in joining Stripe](https://www.kalzumeus.com/2016/09/09/im-joining-stripe-to-work-on-atlas/).
...
My job within the group will remain a bit tough to pigeonhole. I’m not and haven’t been a manager at Stripe; I’m a senior IC.
...
**Consultative work**: I spend a lot of time on community work (including on HN and [Twitter](https://stripe.com/patio11)), work directly with individual users, and advocate for some user personas internally.
...
In addition to this, every time I convince a Stripe customer to [raise their prices](https://stripe.com/atlas/guides/saas-pricing) or otherwise improve their business, we benefit directly. “I am employed to tell people to Charge MoreTM” sounds like a self-deprecating joke, but you could imagine me attaching a spreadsheet to performance reviews. One sheet would be my best guess of how many software founders would listen to my advice, one would calculate the relative distribution of $100k, $1M, $10M, and $100M annual revenues among software companies, and one would include observed uplift after implementation of advice.
...
People sometimes ask whether we’ll [retain our startup-focused soul while increasingly serving enterprises](https://twitter.com/patrickc/status/1308777619454795782). A portion of my job is helping folks communicate that we’re serious, reliable infrastructure for the largest participants in the global economy *while also* keenly appreciating that the user might be on a small team trying to sell  

[bingo cards](https://web.archive.org/web/20151001000000*/discuss.joelonsoftware.com/default.asp?biz.5.359246.16) or [politically-themed breakfast cereal](https://www.airbnb.com/obamaos). This sometimes means intervening if it looks like we’re not living up to our expectations. We care about supporting upstarts because that increases economic opportunity worldwide, which is a worthy mission to have. Also, directly relevant to the business, you never know what people are going to go on to accomplish.
...
Read “hypergrowth” as “sustained, geometrically compounding growth in most metrics of interest, persisting for years at a time, at growth rates which one does not see sustained for years in almost any field of human endeavor except at hypergrowth companies.”
...
We keep shipping things, including both incremental improvements to the N dimensional capabilities matrix that is Payments (e.g. [expanding JCB acceptance](https://stripe.com/blog/jcb-expansion)) and fully new products like e.g. [Corporate Card](https://stripe.com/corporate-card). One thing coming down the pipe is more exciting to me personally than anything since Stripe Atlas.
...
I used to read [essays](https://firstround.com/review/hypergrowth-and-the-law-of-startup-physics/) about how some people don’t “grow with the company” they founded and leave it to start something again, or how some people have a preferred stage of company. These never made intuitive sense until seeing much more range in four years than my career had exposed me to in the 15 prior.
...
There exists a [theory](https://www.amazon.com/Bullshit-Jobs-Theory-David-Graeber/dp/150114331X) that much of the work involved in keeping complex organizations running either doesn’t create or actively destroys value. I think this theory is *heavily overendorsed*. There is value created off screen, too, but if your relationship to companies is as a user, you will not perceive it and therefore underestimate it.
...
Much of my job is being an accelerant for this change. It involves democratizing access to the folkways of Silicon Valley, both via scalably publishing about them (e.g. writing this [guide about pitching a startup](https://stripe.com/atlas/guides/pitching)) and via less public conversations. I also have spent many cycles working on Stripe’s ongoing expansion, including our acceleration of remote work and helping to make a heavily international organization a cohesive culture.
...
Combine this model and what a former colleague [dubbed](https://twitter.com/mmcgrana/status/1260250538299408387) Patio11’s Law (“The software economy is larger than you think, even after taking into account Patio11’s Law”) and you have my biggest surprise since joining Stripe.
...
Want to work on them, or other worthy challenges, as our company starts to exit the awkward teenage years? We’re [hiring](https://stripe.com/jobs).
...
1. IC is short for “individual contributor”, which is corporate America speak for “directly does the work rather than managing the people who do the work.” At the same time, senior ICs are also supposed to exercise a form of leadership. Capacity to do that and also “get my hands dirty” in the same day is part of the job. [↩](#ipfootnote6)
2. I will say that growth rates at many software companies which would generally be considered to be past the hypergrowth stage have been historically unprecedented in the last few years. Microsoft—Microsoft!—has added four Microsofts—**four Microsofts**—since 2015. I think tech has spent *far* too little brainpower on figuring out how that happened. Our models of the world were *shattered* and we have largely slept through it. [↩](#ipfootnote7)
3. Stripe doesn’t have a CMS yet, though we are getting around to it. Almost every page on stripe.com is an artisanally crafted [.erb](https://www.stuartellis.name/articles/erb/) file. [↩](#ipfootnote8)
4. There is a meritocracy in our class system and a class system in our meritocracy, and I feel that this is underexamined because the nuances discomfit both people who understand the nature of merit and those who understand the nature of class systems. [↩](#ipfootnote9)
5. There is beauty, purpose, and dignity in running the neighborhood sandwich shop. Contrary to some memeplexes in Silicon Valley, I don’t think that a firm (or founder) which would sacrifice growth rates for other worthy goals is even implicitly doing something wrong. [↩](#ipfootnote10)
6. Structurally equivalent? Just like finance people see an office building as a balance sheet and cash flows, I see an office building as a SaaS company plus some glass and concrete[7](#ipfootnote11). [↩](#ipfootnote12)
7. [1](#ipfootnote0)
8. [2](#ipfootnote1)
9. [3](#ipfootnote2)
10. [4](#ipfootnote3)
11. [5](#ipfootnote4)
12. I take this joke *extremely* seriously. How many office buildings could we find capital for in Chicago, at rent rolls of $100k a year to $10M a year? That’s about how many SaaS companies should exist. In Chicago. Office buildings aren’t venture fundable, but that doesn’t mean they’re not an investable asset class. I think non-rocketship SaaS is [getting](https://tinyseed.com/thesis) [there](https://earnestcapital.com/investment-memo-fund-2/), [too](https://www.indie.vc/faq). [↩](#ipfootnote13)
13. [6](#ipfootnote5)
14. [7](#ipfootnote11)