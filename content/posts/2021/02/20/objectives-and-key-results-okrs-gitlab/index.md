---
title: Objectives and Key Results (OKRs) | GitLab
date: '2021-02-20T15:04:52-07:00'
format: link
service: instapaper
tags:
- read
external_url: https://about.gitlab.com/company/okrs/
---
...
1. You are here:
2. [About GitLab](https://about.gitlab.com/company/)
3. Objectives and Key Results (OKRs)

#### Maintained by:


[![](https://about.gitlab.com/images/team/stellatreas-crop.jpg)![](https://about.gitlab.com/images/team/stellatreas-crop.jpg)
Stella Treas
...
* [FY22-Q2](https://about.gitlab.com/company/okrs/fy22-q2)
* [FY22-Q1 (active)](https://about.gitlab.com/company/okrs/fy22-q1)

## What are OKRs?

[OKRs](https://en.wikipedia.org/wiki/OKR) stand for Objectives and Key Results and are our quarterly objectives.  

OKRs are *how* to achieve the goal of the Key Performance Indicators [KPIs](https://about.gitlab.com/handbook/ceo/kpis/).  

They lay out our plan to execute our [strategy](https://about.gitlab.com/company/strategy/) and help make sure our goals and how to achieve that are clearly defined and aligned throughout the organization.  
...
We do not use it to [give performance feedback](https://about.gitlab.com/handbook/people-group/360-feedback/) or as a [compensation review](https://about.gitlab.com/handbook/total-rewards/global-compensation/#annual-compensation-review) for team members.
...
The [Chief of Staff](https://about.gitlab.com/job-families/chief-executive-officer/chief-of-staff/) initiates and guides the OKR process.
...
Things that happen every quarter are measured with [Key Performance Indicators](https://about.gitlab.com/handbook/ceo/kpis).  
...
OKRs are like [Portfolio Management](https://about.gitlab.com/handbook/product/categories/#portfolio-management-group) so we are [dogfooding](https://about.gitlab.com/handbook/values/#dogfooding) those features to track our OKR progress over the course of a quarter.  
...
With [health statuses](https://about.gitlab.com/releases/2020/04/22/gitlab-12-10-released/index.html#epic-and-issue-health-tracking), each of the CEO OKRs maps to an epic, and the progress of all cascading OKRs can be seen at-a-glance.

![](https://about.gitlab.com/company/okrs/okr-epic-at-a-glance.png)![](https://about.gitlab.com/company/okrs/okr-epic-at-a-glance.png)
...
The CEO has three objectives every quarter. While we focus on driving revenue, product enhancement and team objectives, many objectives will also support our [strategy](https://about.gitlab.com/strategy/#three-year-strategy):

1. Grow [net ARR](https://about.gitlab.com/handbook/sales/sales-term-glossary/arr-in-practice/#net-arr)
2. Popular next generation product
3. Highly performant team
...
We value [iteration](https://about.gitlab.com/handbook/values/#iteration). We can change an objective or KR if we find that in our pursuit of the initial KR we have not set the optimal goal. Here are a few examples of when this could happen:
...
3. A KR is related to achievement of a new inititiave, and it is agreed that we should pivot in terms of scope or focus as we learn more about what we want to achieve

It is better to update an objective or KR than continue to work toward a goal that is not best aligned with desired business [results](https://about.gitlab.com/handbook/values/#results). In instances where CEO KRs are being updated in the spirit of iteration, post an MR in the #okrs Slack channel and tag the CEO and Chief of Staff for approval. Approval of the MR indicates that the revised goal has been agreed upon. At this point, you can also update the issue or epic to reflect changes.
...
Top level CEO KRs will appear in the handbook. OKRs have numbers attached to them for [ease of reference, not for ranking](https://about.gitlab.com/handbook/communication/#numbering-is-for-reference-not-as-a-signal). In order to maintain a [single source of truth](https://about.gitlab.com/handbook/documentation/#documentation-is-the-single-source-of-truth-ssot), starting in Q4 FY21, we’re putting functional objectives and KRs in epics and issues that should link to the CEO KR epics that are linked on the handbook page. We made this change, because the handbook and epics were not being consistently updated, so there often wasn’t a single source of truth. We were also struggling with merge conflicts as regular changes were being made to the handbook page.

Functional leaders are responsible for updating the their objectives and KRs in their epics and issues before each [Key Meeting](https://about.gitlab.com/handbook/finance/key-meetings/#automated-kpi-slides).
...
2. [ISSUE] Title KR: Key result
3. [ISSUE] Title KR: Key result
...
For Development we use the [Development Department Issue Board](https://gitlab.com/gitlab-com/www-gitlab-com/-/boards/1008667?label_name%5B%5D=Development%20Department) to track OKRs, organized by each sub-department. Each group creates their own tracking issue with the description of the issue linking out to and . Instructions for creating the tracking issue:

1. Create a tracking issue using the `engineering-okr` template ([link](https://gitlab.com/gitlab-com/www-gitlab-com/-/issues/new?issuable_template=engineering-okr&issue%5Btitle%5D=FYYY-QQ%20Group%20Name%20OKRs))
2. Note: The `engineering-okr` template can be used by any department, simply remove the ~”Engineering Management” label
3. Note: you will need to add your own department (e.g. ~Development) and sub-deparment label (e.g. ~”Enablement Sub-department” )
4. Update the title to the following format: FYYY-Q# Group Name OKRs (e.g. FY21-Q2 Growth Sub-department OKRs)
5. As you create and following the instructions below, be sure to update the body of this tracking issue with the titles and links.
...
2. [Format the epic title](https://about.gitlab.com/company/okrs/#format-of-objectives-and-key-results-in-epics-and-issues) to match the company OKR title
3. Optional – add labels for your group or sub-department or department
4. Add the newly created epic to your manager’s objective in the same category (e.g. Product, Team, Net ARR). This is so that all objective roll up to the CEO objective of the same category and everyone can see a cascading view of objectives
5. Update the with the title and link of this newly created objective

#### Key Results

Each will contain one or more Key Result issues. Instructions:

1. Create a [new issue](https://gitlab.com/gitlab-com/www-gitlab-com/-/issues/new?issuable_template=engineering-kr&issue%5Btitle%5D=FYYY-QQ%20Group%20Name%20KR:%20Text)
2. The title format is FYYY-QQ Group Name KR: Text (e.g. FY21-Q3 Protect Group KR: Protect our Code!)
3. Add the following labels: ~OKR ~”Engineering Management” and the label for your department (e.g. ~”Development Department” and sub-department (e.g. ~”Dev Sub-department” )
4. Add labels for your `group` (e.g. ~group::compliance)
5. Assign to yourself (or appropriate person)
6. Link to the appropriate Objective Epic
7. Add the newly created Key Result , under the correct listing, in the
## Maintaining the status of OKRs

Teams should update the Health Status of their KR issues and present them in their [Key Meeting](https://about.gitlab.com/handbook/finance/key-meetings).  
...
During key meetings, team’s should include [OKR slides](https://about.gitlab.com/handbook/finance/key-meetings/#okr-slides) that share status details and link to relevant epics and issues.
...
* [FY21-Q4](https://about.gitlab.com/company/okrs/fy21-q4/)
* [FY21-Q3](https://about.gitlab.com/company/okrs/fy21-q3/)
* [FY21-Q2](https://about.gitlab.com/company/okrs/fy21-q2/)
* [FY21-Q1](https://about.gitlab.com/company/okrs/fy21-q1/)
* [FY20-Q4](https://about.gitlab.com/company/okrs/fy20-q4/)
* [FY20-Q3](https://about.gitlab.com/company/okrs/fy20-q3/)
* [FY20-Q2](https://about.gitlab.com/company/okrs/fy20-q2/)
* [FY20-Q1](https://about.gitlab.com/company/okrs/fy20-q1/)
* [CY18-Q4](https://about.gitlab.com/company/okrs/2018-q4/)
* [CY18-Q3](https://about.gitlab.com/company/okrs/2018-q3/)
* [CY18-Q2](https://about.gitlab.com/company/okrs/2018-q2/)
* [CY18-Q1](https://about.gitlab.com/company/okrs/2018-q1/)
* [CY17-Q4](https://about.gitlab.com/company/okrs/2017-q4/)
* [CY17-Q3](https://about.gitlab.com/company/okrs/2017-q3/)