...
date: '2021-08-03T23:06:51-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://martinfowler.com/articles/platform-prerequisites.html
---
...
![](https://martinfowler.com/articles/platform-prerequisites/mind-the-gap.png)![](https://martinfowler.com/articles/platform-prerequisites/mind-the-gap.png)
...
DevEx stands for Developer Experience, a role that many technical  

product organisations are adopting to ensure their customers not only  

adopt their tools, but are also productive when doing so. When you have  

an internal customer base, an equivalent role that supports product  

development teams using your platform could be of value.

DevEx roles contribute to the adoption of your platform in three  

different ways. First, by ensuring that customers’ concerns have a way  

to reach the platform team. This feedback loop provides enormous value  

when building any product. Second, they disseminate knowledge of the  

product and how to use it effectively through the creation of technical  

content and social events. Third, as pointed out by Geertjan Wielenga in  

[Developer, Advocate!](https://www.amazon.com/gp/product/B07Y8L823L/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B07Y8L823L&linkCode=as2&tag=martinfowlerc-20), they build  

and hold a community together through networking and interactions.

Whether or not you assign a specific DevEx role, the practices of the  

developer experience discipline should serve as inspiration for your  
...
code, as defined by Kief Morris in his book  [Infrastructure as Code](https://www.amazon.com/gp/product/1491924357/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=1491924357&linkCode=as2&tag=martinfowlerc-20):
...
Though they were originally conceived for product development teams,  

we find that the principles of [Extreme Programming](https://martinfowler.com/bliki/ExtremeProgramming.html) are  

an excellent guide for healthy platform teams. Kent Beck tells us that  

the paradigm for XP is: Stay aware. Adapt. Change. This is as crucial  

for a platform initiative as for any other.

The difference between a team and a group of individuals are the  

existence of a common set of goals and values (the XP values are  

communication, simplicity, feedback, courage, and respect) as well as  

the presence of a high bandwidth, low latency medium that they use to  

communicate (Sit Together). The team has within it all the skills that  

are necessary to complete its mission. For platform teams who follow our  

advice, they will be composed of individuals with a mix of product,  

communication, operations and software engineering skills (Whole Team).  

The team works at a sustainable pace that acknowledges the daily limits  

of effective knowledge work, which for platform teams must take into  

account the impact of toil and out-of-hours support (Energized Work).  

They also ensure that information about the status of the work is  

visible at all times, which includes both progress on planned features  

and observability on running systems (Informative Workspace).

In XP, work is organised in themes that define a team’s priorities  

over the medium term (Quarterly Cycle). It is carried out in short  

cycles where the team delivers working software increments that get them  

closer to their objectives (Weekly Cycle). The knowledge that  

uncertainty is unavoidable when creating software systems leads the team  

not to commit its full theoretical capacity but to leave some room to  

manage the unexpected (Slack). Fixed date/fixed scope projects are as  

unrealistic in conventional product work as it is in platforms.

Building each one of the items expected to be addressed in one of the  

weekly cycles (Stories) starts with a test (Test-First Programming). For  

technical platforms, those tests might not be initially trivial but much  

is accomplished when the team focuses on creating them. Also, just the  

right amount of design needed is put in place so that those items can be  

implemented without putting at risk our capability of changing the  

system as new information emerges (Incremental design). Changes into the  

code are integrated frequently and the team ensures that the build  

process is always fast enough to ensure this integration is painless  

(Continuous Integration, Ten-Minute Build).

The figure of the operations firefighter who keeps the infrastructure  

standing through individual heroism, nocturnal sacrifice and a  

preternatural understanding of their organisation’s technical history  

has no place now in platform development, if it ever did. Healthy  

platforms are sustained by healthy teams.
...
Manuel Pais’s book [Team Topologies](https://www.amazon.com/gp/product/B07NSF94PC/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B07NSF94PC&linkCode=as2&tag=martinfowlerc-20),  
...
[[1]](#ipfootnote0) we can build* that would help the product teams?  
...
1. 1:   
   ...
   “Thinnest viable platform” according to [Team Topologies](https://www.amazon.com/gp/product/B07NSF94PC/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B07NSF94PC&linkCode=as2&tag=martinfowlerc-20).