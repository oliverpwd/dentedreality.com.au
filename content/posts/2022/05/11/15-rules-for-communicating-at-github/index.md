...
date: '2022-05-11T15:14:03-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://ben.balter.com/2014/11/06/rules-of-communicating-at-github/
---
...
1. **It’s not the obnoxious bump** – Be sincere, explicit, and charming. “[@benbalter](https://github.com/benbalter), the gentlest of bumps on this. Have two minute to take a look at this error? ![](https://github.githubassets.com/images/icons/emoji/unicode/1f604.png)![](https://github.githubassets.com/images/icons/emoji/unicode/1f604.png)”. Your goal is to make sure that they are aware of the ask, not to trample their right to manage their own time.
...
The great thing about issues and pull requests, in contrast to say, email, is that they can be bifurcated when topics diverge. This keeps teams focused on ![](https://github.githubassets.com/images/icons/emoji/unicode/1f6a2.png)![](https://github.githubassets.com/images/icons/emoji/unicode/1f6a2.png)ing one thing and only one thing at a time. Additionally, discrete topics minimize unnecessary noise and optimize for fast decision making by ensuring only the most relevant teams are involved.
