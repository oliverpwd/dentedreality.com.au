---
title: Mission, Strategy, and Tactics
date: '2022-05-17T07:56:21-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://boz.com/articles/strategy-tactics
---
...
* A mission statement should be short. It isn’t answering **how** or **why** but  
  ...
  never really addressed as it should be implicit.
* A mission statement should take a stance. It should not be an unobjectionable,  
  
  empty slogan. It should assert a point of view strongly enough that it is a  
  
  useful tool in planning and prioritizing work.
* A mission statement should inspire people. You should be able to use it to  
  
  recruit.
* A mission statement should probably start with a verb.
* A mission statement should describe something aspirational, hard, and  
  
  probably not even obviously possible
* A mission statement should stand the test of time. Mission statements change  
