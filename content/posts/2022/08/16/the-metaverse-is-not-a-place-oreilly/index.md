---
title: The Metaverse Is Not a Place – O’Reilly
date: '2022-08-16T11:51:31-06:00'
format: link
service: instapaper
tags:
- read
...
[The Metaverse Is Not a Place – O’Reilly](https://www.oreilly.com/radar/the-metaverse-is-not-a-place/)  



The metaphors we use to describe new technology constrain how we think about it, and, [like an out-of-date map](https://www.linkedin.com/pulse/20121029141916-16553-language-is-a-map), often lead us astray. So it is with the metaverse. Some people seem to think of it as [a kind of real estate](https://news.bitcoin.com/metaverse-real-estate-sales-to-grow-by-5-billion-by-2026/), complete with land grabs and the attempt to bring traffic to whatever bit of virtual property they’ve created.

![](https://www.oreilly.com/radar/wp-content/uploads/sites/3/2022/08/the_metaverse_is_not_a_place_01.png)![](https://www.oreilly.com/radar/wp-content/uploads/sites/3/2022/08/the_metaverse_is_not_a_place_01.png)

Seen through the lens of the real estate metaphor, the metaverse becomes a natural successor not just to [Second Life](https://en.wikipedia.org/wiki/Second_Life) but to the World Wide Web and to social media feeds, which can be thought of as a set of places (sites) to visit. Virtual Reality headsets will make these places more immersive, we imagine.

 [![](https://d3ansictanv2wj.cloudfront.net/safari-topic-cta-1f60e6f96856da19ba3cb25660472ca5.jpg)![](https://d3ansictanv2wj.cloudfront.net/safari-topic-cta-1f60e6f96856da19ba3cb25660472ca5.jpg)](https://www.oreilly.com/online-learning/)
...
[Learn more](https://www.oreilly.com/online-learning/)
...
In an interview with Lex Fridman, Mark Zuckerberg disclaimed the notion of the metaverse as a place, but in the same sentence [described its future in a very place-based way](https://youtu.be/5zOHSysMmH0?t=1019):
...
Hacker News user [kibwen put it beautifully](https://news.ycombinator.com/item?id=29083271) when they wrote:
...
I wrote about this idea back in 2020, in a piece called “[Welcome to the 21st Century](https://www.oreilly.com/tim/21stcentury/),” in the context of using [scenario planning](https://www.wired.com/1995/11/how-to-build-scenarios/) to imagine the post-COVID future. It’s worth recapping here:
...
4. I talked to [Phil Libin](https://www.sequoiacap.com/article/phil-libin-mmhmm-spotlight/) about his brilliant service [mmhmm](https://www.mmhmm.app/), which makes it easy to create and deliver richer, more interactive presentations over Zoom and similar apps. The speaker literally gets to occupy the space of the presentation. Phil’s presentation on “[The Out of Office World](https://www.youtube.com/watch?v=mBKIMhGO8WA)” was where it all clicked. He talks about the hierarchy of communication and the tools for modulating it. (IMO this is a must-watch piece for anyone thinking about the future of internet apps. I’m surprised how few people seem to have watched it.)


1. Trying [Supernatural](https://www.getsupernatural.com/) using the Meta Quest 2 headset completed the connection between my experience using Zoom and Peloton for fitness with friends and the VR-dominant framing of the metaverse. Here I was, standing on the edge of one of the lava lakes at [Erta Ale](https://www.atlasobscura.com/places/erta-ale) in Ethiopia, an astonishing volcano right out of central casting for Mount Doom in *The Lord of the Rings*, working through warm-up exercises with a video of a fitness instructor green-screened into the scene, before launching into a boxing training game. Coach Susie was present in stored time, just like Robin and Rad. All that was missing was Jen and Sabrina. I’m sure that such shared experiences in remarkable places are very much part of the VR future.

[![](https://www.oreilly.com/radar/wp-content/uploads/sites/3/2022/08/the_metaverse_is_not_a_place_02.png)![](https://www.oreilly.com/radar/wp-content/uploads/sites/3/2022/08/the_metaverse_is_not_a_place_02.png)](https://www.youtube.com/watch?v=jufCUdibP4c)

That kind of shared experience is central to Mark Zuckerberg’s vision of [socializing in the metaverse](https://www.youtube.com/watch?v=b9vWShsmE20).
...
In this regard, an interesting sidenote came from a virtual session that we held earlier this year at the Social Science Foo Camp (an event put together annually by O’Reilly, Meta, and Sage) using the [ENGAGE](https://engagevr.io/) virtual media conferencing app. The group began their discussion in one of the default meeting spaces, but one of the attendees, Adam Flaherty, proposed that they have it in a more appropriate place. They moved to a beautifully rendered version of [Oxford’s Bodleian Library](https://en.wikipedia.org/wiki/Bodleian_Library), and attendees reported that the entire tenor of the conversation changed.
...
* **Cryptocurrencies and “Web3.”** Does crypto/Web3 provide new business models for the metaverse? (BTW, I enjoyed the way that Neal Stephenson, in [*Reamde*](https://en.wikipedia.org/wiki/Reamde), had his character design the business model and money flows for his online game before he designed anything else. Many startups just try to get users and assume the business model will follow, but that has led us down the dead end of advertising and [surveillance capitalism](https://en.wikipedia.org/wiki/Surveillance_capitalism).)
* **Identity.** Most of today’s identity systems are centralized in one way or another, with identity supplied by a trusted provider or verifier. Web3 proponents, however, are exploring a variety of systems for decentralized “[self-sovereign identity](https://en.wikipedia.org/wiki/Self-sovereign_identity),” including Vitalik Buterin’s “[soulbound tokens](https://vitalik.eth.limo/general/2022/01/26/soulbound.html).” The vulnerability of crypto systems to [Sybil attacks](https://en.wikipedia.org/wiki/Sybil_attack) in the absence of verifiable identity is driving a lot of innovation in the identity space. [Molly White’s skeptical survey of these various initiatives](https://blog.mollywhite.net/is-acceptably-non-dystopian-self-sovereign-identity-even-possible/) is a great overview of the problem and the difficulties in overcoming it. Gordon Brander’s “[Soulbinding Like A State](https://subconscious.substack.com/p/soulbinding-like-a-state),” a riff on Molly White’s post and James C. Scott’s [*Seeing Like A State*](https://en.wikipedia.org/wiki/Seeing_Like_a_State), provides a further warning: “Scott’s framework reveals…that the dangers of legibility are not related to the sovereignty of an ID. There are many reasons self-sovereignty is valuable, but the function of a self-sovereign identity is still to make the bearer legible. What’s measured gets managed. What’s legible gets controlled.” As is often the case, no perfect solution will be found, but society will adopt an imperfect solution by making trade-offs that are odious to some, very profitable to others, and that the great mass of users will passively accept.
