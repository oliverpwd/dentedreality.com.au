...
date: '2022-10-01T12:21:44-06:00'
format: link
service: instapaper
tags:
- read
external_url: https://lucasfcosta.com/2022/08/31/engineering-metrics.html
---
...
[![](https://lucasfcosta.com/assets/eng-metrics/eng-queue.png)![](https://lucasfcosta.com/assets/eng-metrics/eng-queue.png)](https://lucasfcosta.com/assets/eng-metrics/eng-queue.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/arrivals-and-departures.png)![](https://lucasfcosta.com/assets/eng-metrics/arrivals-and-departures.png)](https://lucasfcosta.com/assets/eng-metrics/arrivals-and-departures)
...
[![](https://lucasfcosta.com/assets/eng-metrics/queues-increase-cycle-times.png)![](https://lucasfcosta.com/assets/eng-metrics/queues-increase-cycle-times.png)](https://lucasfcosta.com/assets/eng-metrics/queues-increase-cycle-times.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/cfd-0.png)![](https://lucasfcosta.com/assets/eng-metrics/cfd-0.png)](https://lucasfcosta.com/assets/eng-metrics/cfd-0.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/cfd-arrivals-greater-than-departures.png)![](https://lucasfcosta.com/assets/eng-metrics/cfd-arrivals-greater-than-departures.png)](https://lucasfcosta.com/assets/eng-metrics/cfd-arrivals-greater-than-departures.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/cfd-arrivals-equal-than-departures.png)![](https://lucasfcosta.com/assets/eng-metrics/cfd-arrivals-equal-than-departures.png)](https://lucasfcosta.com/assets/eng-metrics/cfd-arrivals-equal-than-departures.png)
...
Avg. Cycle Time=Avg. ThroughputAvg. Work In Progress​
...
[![](https://lucasfcosta.com/assets/eng-metrics/multi-queue-system.png)![](https://lucasfcosta.com/assets/eng-metrics/multi-queue-system.png)](https://lucasfcosta.com/assets/eng-metrics/multi-queue-system.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/multi-queue-cfd.png)![](https://lucasfcosta.com/assets/eng-metrics/multi-queue-cfd.png)](https://lucasfcosta.com/assets/eng-metrics/multi-queue-cfd.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/multi-queue-cfd-annotated.png)![](https://lucasfcosta.com/assets/eng-metrics/multi-queue-cfd-annotated.png)](https://lucasfcosta.com/assets/eng-metrics/multi-queue-cfd-annotated.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/bulging-review-band.png)![](https://lucasfcosta.com/assets/eng-metrics/bulging-review-band.png)](https://lucasfcosta.com/assets/eng-metrics/bulging-review-band.png)
...
Other times, our bottlenecks are temporary because we’re not reproducing the same work repeatedly. Instead, we’re creating the *recipe* for new workpieces, which implies variability.  
...
[![](https://lucasfcosta.com/assets/eng-metrics/flat-line-cfd.png)![](https://lucasfcosta.com/assets/eng-metrics/flat-line-cfd.png)](https://lucasfcosta.com/assets/eng-metrics/flat-line-cfd.png)
...
Imagine, for example, that your deployment process is manual and time-consuming. In that case, there’s a high *transaction cost* of moving items from the “deployment” stage to the “done” stage.

Such large batch transferrals will show up as “stair steps” in your cumulative flow diagram.

[![](https://lucasfcosta.com/assets/eng-metrics/stair-steps-cfd.png)![](https://lucasfcosta.com/assets/eng-metrics/stair-steps-cfd.png)](https://lucasfcosta.com/assets/eng-metrics/stair-steps-cfd.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/starving-reviews.png)![](https://lucasfcosta.com/assets/eng-metrics/starving-reviews.png)](https://lucasfcosta.com/assets/eng-metrics/starving-reviews.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/cfd-flow-debt.png)![](https://lucasfcosta.com/assets/eng-metrics/cfd-flow-debt.png)](https://lucasfcosta.com/assets/eng-metrics/cfd-flow-debt.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/scatterplot-stage-age.png)![](https://lucasfcosta.com/assets/eng-metrics/scatterplot-stage-age.png)](https://lucasfcosta.com/assets/eng-metrics/scatterplot-stage-age.png)
...
[![](https://lucasfcosta.com/assets/eng-metrics/cycle-time-histogram.png)![](https://lucasfcosta.com/assets/eng-metrics/cycle-time-histogram.png)](https://lucasfcosta.com/assets/eng-metrics/cycle-time-histogram.png)
...
Finally, another way to identify flow debt is to look at your *“flow efficiency”*. A team’s flow efficiency measures the percentage of time items spend in a blocking state.
...
You can use a cycle-time scatterplot to detect \_flow debt\_and look for outliers. Alternatively, you could use a cycle time histogram and look for a bimodal distribution.
...
**If you’d like to have a chat, [you can book a slot with me here](https://calendly.com/lucasfcosta/1-1-with-lucas)**.